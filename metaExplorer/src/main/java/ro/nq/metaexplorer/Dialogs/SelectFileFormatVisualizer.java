...
public class SelectFileFormatVisualizer implements Initializable {
// ---- [class constants]
    public static final ClassConstants classConstants = new ClassConstants(
        SelectFileFormatVisualizer.class,
            "SelectFileFormatVisualizer",
            "SelectFileFormatVisualizer.fxml",
            "SelectFileFormatVisualizer.css",
            "ro.nq.metaexplorer.Dialogs.SelectFileFormatVisualizer"
    );
...
public Parent parent;
    public SelectFileFormatVisualizer(Terminal application) {
        ...
        try {
            ...
            System.out.println("{SelectFileFormatVisualizer} [] (FXMLLoader.load()) - Parent: " + this.parent);

            this.scene = new Scene(this.parent);
            this.window.setScene(this.scene);
        }
        catch (IOException exception) {
            System.out.println("{SelectFileFormatVisualizer} [IOException] (FXMLLoader.load()) - " + exception.getMessage() + "\t" + exception.getCause());
        }
    }
// ---- [controllers]
    // none yet
...
// ---- [listeners]
    InvalidationListener languageListener = new InvalidationListener() {
        ...
        public void invalidated(Observable invalidation) {
            System.out.println("Language invalidation in ::SelectFileFormatVisualizer");
